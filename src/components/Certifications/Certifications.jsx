...
import uipath from "../../assets/images/certificates/uipath.png";
import datascience from "../../assets/images/certificates/datascience.jpg";
    ...
    <section className="section pin-section" id="certification" ref={sectionRef}>
      ...
      <div className="content">
        <ul className="certification-list">
          ...
          <li>RPA Developer By Ui-Path</li>
          <li>Data Science Job Simulation</li>
        </ul>
